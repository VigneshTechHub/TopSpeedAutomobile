...
namespace TopSpeed.Infrastructure.Common
{
    public static class ExtensionMethod
    {
        ...
        public static async void SaveCommonFields(this ApplicationDbContext dbContext, UserManager<IdentityUser>
            _userManager, IHttpContextAccessor _contextAccessor)
        {
